 ...
 */
(function (c, h) {
    "function" === typeof define && define.amd ? define(["jquery.easings.min"], function (k) {
        return h(k, c, c.document, c.Math)
    }) : "undefined" !== typeof exports ? module.exports = h(require("jquery"), c, c.document, c.Math) : h(jQuery, c, c.document, c.Math)
})("undefined" !== typeof window ? window : this, function (c, h, k, m, I) {
    var l = c(h), r = c(k);
    c.fn.fullpage = function (d) {
        ...
        function ea() {
            ...
            a.find(".fp-scrollable").mouseover();
            c.isFunction(d.afterLoad) && d.afterLoad.call(a, a.data("anchor"), a.index(".fp-section") +
                1);
        ...
        function fa() {
            ...
            if (!d.autoScrolling || d.scrollBar) {
                for (var b = l.scrollTop(), g = 0, n = m.abs(b - k.querySelectorAll(".fp-section")[0].offsetTop), e = k.querySelectorAll(".fp-section"), f = 0; f < e.length; ++f) {
            ...
            if (!d.autoScrolling || d.scrollBar) {
                if (!a.hasClass("active")) {
                    ...
                    if (h.length)var p = h.data("anchor"), q = h.index();
                    t && (a.addClass("active").siblings().removeClass("active"), c.isFunction(d.onLeave) && d.onLeave.call(b, g, f, n), c.isFunction(d.afterLoad) && d.afterLoad.call(a, e, f), K(e, f - 1), d.anchors.length && (z = e, W(q, p, e, f)));
                    clearTimeout(ga);
                    ga = setTimeout(function () {
                        U = !1
                    }, 100)
                }
                d.fitToSection && (clearTimeout(ha), ha = setTimeout(function () {
                    t && (c(".fp-section.active").is(a) && (w = !0), A(a), w = !1)
                }, 1E3))
            }
        }

        function ia(a) {
            return a.find(".fp-slides").length ? a.find(".fp-slide.active").find(".fp-scrollable") :
        ...
        function Ja(a) {
            ...
            if (!ja(a.target) && X(b)) {
                ...
                var g = ia(a);
                t && !B && (b = ka(b), E = b.y, M = b.x, a.find(".fp-slides").length && m.abs(N - M) > m.abs(F - E) ? m.abs(N - M) > l.width() /
                100 * d.touchSensitivity && (N > M ? p.right && e.moveSlideRight() : p.left && e.moveSlideLeft()) : d.autoScrolling && m.abs(F - E) > l.height() / 100 * d.touchSensitivity && (F > E ? L("down", g) : E > F && L("up", g)))
            }
        }
        ...
        function ja(a, b) {
            b = b || 0;
            var g = c(a).parent();
            return b < d.normalScrollElementTouchThreshold && g.is(d.normalScrollElements) ? !0 : b == d.normalScrollElementTouchThreshold ? !1 : ja(g, ++b)
        }
        ...
        function Ka(a) {
            a = a.originalEvent;
            d.fitToSection && v.stop();
            X(a) && (a =
                ka(a), F = a.y, N = a.x)
        }

        function la(a, b) {
            for (var d = 0, c = a.slice(m.max(a.length - b, 1)), e = 0; e < c.length; e++)d += c[e];
            return m.ceil(d / b)
        }

        function C(a) {
            var b = (new Date).getTime();
            if (d.autoScrolling && !Y) {
                a = h.event || a;
                var g = a.wheelDelta || -a.deltaY || -a.detail, n = m.max(-1, m.min(1, g));
                ...
                ma = b;
                200 < g && (D = []);
                t && (b = la(D, 10), g = la(D, 70), b >= g && (0 > n ? L("down", a) : L("up", a)));
                return !1
            }
            d.fitToSection &&
            v.stop()
        ...
        function na(a) {
            ...
            if (b.length && !B) {
                var g = b.find(".fp-slide.active"), n = null, n = "prev" === a ? g.prev(".fp-slide") : g.next(".fp-slide");
                if (!n.length) {
                    if (!d.loopHorizontal)return;
                    n = "prev" === a ? g.siblings(":last") : g.siblings(":first")
                }
                B = !0;
                G(b, n)
            }
        ...
        function A(a, b, g) {
            ...
            if ("undefined" !== typeof n && (b = {
                    ...
                    localIsResizing: w
                }, !(b.activeSection.is(a) && !w || d.scrollBar && l.scrollTop() === b.dtop))) {
                if (b.activeSlide.length)var e = b.activeSlide.data("anchor"), f = b.activeSlide.index();
                d.autoScrolling && d.continuousVertical && "undefined" !== typeof b.isMovementUp && (!b.isMovementUp && "up" == b.yMovement || b.isMovementUp &&
                ...
                t = !1;
                W(f, e, b.anchorLink, b.sectionIndex);
                c.isFunction(d.onLeave) && !b.localIsResizing && d.onLeave.call(b.activeSection,
                    b.leavingSection, b.sectionIndex + 1, b.yMovement);
                La(b);
                z = b.anchorLink;
        ...
        function La(a) {
            if (d.css3 && d.autoScrolling && !d.scrollBar)pa("translate3d(0px, -" + a.dtop + "px, 0px)", !0), setTimeout(function () {
                qa(a)
            }, d.scrollingSpeed); else {
                var b = Ma(a);
        ...
        function Ma(a) {
            var b = {};
            d.autoScrolling && !d.scrollBar ? (b.options = {top: -a.dtop}, b.element = ".fullpage-wrapper") : (b.options = {scrollTop: a.dtop}, b.element =
                "html, body");
            return b
        }

        function qa(a) {
            a.wrapAroundElements && a.wrapAroundElements.length && (a.isMovementUp ? c(".fp-section:first").before(a.wrapAroundElements) : c(".fp-section:last").after(a.wrapAroundElements), x(c(".fp-section.active").position().top), oa());
        ...
        function ra() {
            if (!U) {
                var a = h.location.hash.replace("#",
                    "").split("/"), b = a[0], a = a[1];
                if (b.length) {
                    var d = "undefined" === typeof z, c = "undefined" === typeof z && "undefined" === typeof a && !B;
                    (b && b !== z && !d || c || !B && Z != a) && aa(b, a)
                }
            }
        }

        function Na(a) {
            t && (a.pageY < P ? e.moveSectionUp() : a.pageY > P && e.moveSectionDown());
            P = a.pageY
        }

        function G(a, b) {
            var g = b.position(), e = b.index(), f = a.closest(".fp-section"), h = f.index(".fp-section"), k = f.data("anchor"), l = f.find(".fp-slidesNav"), p = sa(b), q = w;
            if (d.onSlideLeave) {
                var u = f.find(".fp-slide.active"), r = u.index(), t;
                t = r == e ? "none" : r > e ? "left" : "right";
                q || "none" === t || c.isFunction(d.onSlideLeave) && d.onSlideLeave.call(u, k, h + 1, r, t)
            }
            ...
            f.hasClass("active") && W(e, p, k, h);
            var v = function () {
                q || c.isFunction(d.afterSlideLoad) && d.afterSlideLoad.call(b, k, h + 1, p, e);
                B = !1
            };
            d.css3 ? (g = "translate3d(-" + m.round(g.left) + "px, 0px, 0px)", ta(a.find(".fp-slidesContainer"), 0 <
                d.scrollingSpeed).css(ua(g)), setTimeout(function () {
                v()
            }, d.scrollingSpeed, d.easing)) : a.animate({scrollLeft: m.round(g.left)}, d.scrollingSpeed, d.easing, function () {
                v()
            });
        ...
        function va() {
            ...
            if (Q) {
                ...
                a.is("textarea") || a.is("input") || a.is("select") || (a = l.height(), m.abs(a - ba) > 20 * m.max(ba, a) / 100 && (e.reBuild(!0), ba = a))
        ...
        function wa() {
            if (d.responsive) {
                var a =
                    f.hasClass("fp-responsive");
                l.width() < d.responsive ? a || (e.setAutoScrolling(!1, "internal"), e.setFitToSection(!1, "internal"), c("#fp-nav").hide(), f.addClass("fp-responsive")) : a && (e.setAutoScrolling(H.autoScrolling, "internal"), e.setFitToSection(H.autoScrolling, "internal"), c("#fp-nav").show(), f.removeClass("fp-responsive"))
            }
        }
        ...
        function Oa(a, b) {
            if (825 > a || 900 >
                b) {
                var d = m.min(100 * a / 825, 100 * b / 900).toFixed(2);
                q.css("font-size", d + "%")
        ...
        function J(a) {
            ...
            b = u - parseInt(b.css("padding-bottom")) - parseInt(b.css("padding-top"));
        ...
        function Aa(a) {
            ...
            if (d.paddingTop || d.paddingBottom)b = a, b.hasClass("fp-section") || (b = a.closest(".fp-section")), a = parseInt(b.css("padding-top")) +
                parseInt(b.css("padding-bottom")), b = u - a;
            return b
        }
        ...
        function Ba(a, b) {
            var d = b.find(".fp-slides"), c = d.find('.fp-slide[data-anchor="' + a + '"]');
            c.length || (c = d.find(".fp-slide").eq(a));
            return c
        }
        ...
        function Ca(a, b) {
            if ("undefined" !== typeof b) {
                var d = a.find(".fp-slides"), c = Ba(b, a);
                c.length && G(d, c)
            }
        }
        ...
        function W(a, b, c, e) {
            e = "";
            d.anchors.length && (a ? ("undefined" !== typeof c &&
            (e = c), "undefined" === typeof b && (b = a), Z = b, Da(e + "/" + b)) : ("undefined" !== typeof a && (Z = b), Da(c)));
            Ea()
        }

        function Da(a) {
            if (d.recordHistory)location.hash = a; else if (Q || R)history.replaceState(I, I, "#" + a); else {
        ...
        function Qa() {
            ...
            for (var d in c)a.style[d] !== I && (a.style[d] = "translate3d(1px,1px,1px)", b = h.getComputedStyle(a).getPropertyValue(c[d]));
            k.body.removeChild(a);
            return b !== I && 0 < b.length && "none" !== b
        }

        function Ra() {
            if (Q || R) {
                var a = Fa();
                c(".fullpage-wrapper").off("touchstart " + a.down).on("touchstart " + a.down, Ka);
                c(".fullpage-wrapper").off("touchmove " + a.move).on("touchmove " + a.move, Ja)
            }
        }
        ...
        function O(a, b) {
            ...
            "undefined" !== typeof b && (w = !0);
            G(a.closest(".fp-slides"), a);
            "undefined" !== typeof b && (w = !1);
            e.setScrollingSpeed(H.scrollingSpeed, "internal")
        }

        function x(a) {
            d.scrollBar ? f.scrollTop(a) : d.css3 ? pa("translate3d(0px, -" + a + "px, 0px)",
                !1) : f.css("top", -a)
        }
        ...
        var v = c("html, body"), q = c("body"), e = c.fn.fullpage;
        d = c.extend({
            menu: !1,
            anchors: [],
            navigation: !1,
        ...
        (function () {
            ...
            (d.loopTop || d.loopBottom) && (d.continuousVertical = !1, T("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled"));
        ...
        e.setAutoScrolling = function (a, b) {
            ...
            d.autoScrolling && !d.scrollBar ? (v.css({
                overflow: "hidden",
                height: "100%"
            }), e.setRecordHistory(d.recordHistory, "internal"), f.css({
                "-ms-touch-action": "none",
                "touch-action": "none"
            }), g.length && x(g.position().top)) : (v.css({
                overflow: "visible",
                height: "initial"
            }), e.setRecordHistory(!1, "internal"), f.css({
                "-ms-touch-action": "",
                "touch-action": ""
            }), x(0), g.length && v.scrollTop(g.position().top))
        };
        ...
        e.setMouseWheelScrolling = function (a) {
            a ? k.addEventListener ? (k.addEventListener("mousewheel", C, !1), k.addEventListener("wheel", C, !1)) : k.attachEvent("onmousewheel", C) : k.addEventListener ?
                (k.removeEventListener("mousewheel", C, !1), k.removeEventListener("wheel", C, !1)) : k.detachEvent("onmousewheel", C)
        };
        e.setAllowScrolling = function (a, b) {
            ...
            })) : a ? (e.setMouseWheelScrolling(!0), Ra()) : (e.setMouseWheelScrolling(!1), Sa())
        };
        ...
        e.moveTo = function (a, b) {
            var c = ca(a);
            "undefined" !== typeof b ? aa(a, b) : 0 < c.length && A(c)
        };
        ...
        var B = !1, Q = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/), R = "ontouchstart"in h || 0 < navigator.msMaxTouchPoints || navigator.maxTouchPoints,
            f = c(this), u = l.height(), w = !1, z, Z, t = !0, D = [], y, Y, p = {
                up: !0,
                down: !0,
                left: !0,
                right: !0
        ...
        c(".fp-section").each(function (a) {
            var b = c(this), e = c(this).find(".fp-slide"), f = e.length;
            ...
            "undefined" !== typeof d.anchors[a] && (c(this).attr("data-anchor", d.anchors[a]), c(this).hasClass("active") &&
            K(d.anchors[a], a));
            if (0 < f) {
                a = 100 * f;
                var h = 100 / f;
                ...
                d.controlArrows && 1 < f && Ha(c(this));
                d.slidesNavigation && Pa(c(this), f);
                e.each(function (a) {
                    c(this).css("width", h + "%");
                    d.verticalCentered && za(c(this))
                });
                b = b.find(".fp-slide.active");
                b.length ? O(b) : e.eq(0).addClass("active")
            } else d.verticalCentered && za(c(this))
        }).promise().done(function () {
            e.setAutoScrolling(d.autoScrolling,
                "internal");
            var a = c(".fp-section.active").find(".fp-slide.active");
            a.length && (0 !== c(".fp-section.active").index(".fp-section") || 0 === c(".fp-section.active").index(".fp-section") && 0 !== a.index()) && O(a);
            d.fixedElements && d.css3 && c(d.fixedElements).appendTo(q);
            d.navigation && (y.css("margin-top", "-" + y.height() / 2 + "px"), y.find("li").eq(c(".fp-section.active").index(".fp-section")).find("a").addClass("active"));
            d.menu && d.css3 && c(d.menu).closest(".fullpage-wrapper").length && c(d.menu).appendTo(q);
            d.scrollOverflow ?
                ("complete" === k.readyState && da(), l.on("load", da)) : ea();
            wa();
            if (!d.animateAnchor && (a = h.location.hash.replace("#", "").split("/")[0], a.length)) {
                var b = c('[data-anchor="' + a + '"]');
                b.length && (d.autoScrolling ? x(b.position().top) : (x(0), v.scrollTop(b.position().top)), K(a, null), c.isFunction(d.afterLoad) && d.afterLoad.call(b, a, b.index(".fp-section") + 1), b.addClass("active").siblings().removeClass("active"))
            }
            Ea();
            l.on("load", function () {
        ...
        var ga, ha, U = !1;
        l.on("scroll", fa);
        var F = 0, N = 0, E = 0, M = 0, ma = (new Date).getTime();
        l.on("hashchange", ra);
        r.keydown(function (a) {
            clearTimeout(Ga);
            Y = a.ctrlKey;
            var b = c(k.activeElement);
            b.is("textarea") || b.is("input") || b.is("select") || !d.keyboardScrolling || !d.autoScrolling || (-1 < c.inArray(a.which, [40, 38, 32, 33, 34]) && a.preventDefault(), Ga = setTimeout(function () {
                var b = a.shiftKey;
                switch (a.which) {
                    case 38:
                    case 33:
        ...
        f.mousedown(function (a) {
            2 == a.which && (P = a.pageY, f.on("mousemove", Na))
        });
        ...
        c(".fp-section").on("click touchstart", ".fp-controlArrow", function () {
            c(this).hasClass("fp-prev") ? p.left && e.moveSlideLeft() : p.right && e.moveSlideRight()
        });
        l.resize(va);
        var ba = u, xa;
        e.destroy =
            function (a) {
                ...
                l.off("scroll", fa).off("hashchange", ra).off("resize", va);
